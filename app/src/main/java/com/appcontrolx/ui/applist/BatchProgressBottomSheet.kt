...
/**
 * Bottom sheet that shows progress during batch operations.
 * Displays a list of apps being processed with individual status indicators.
 */
class BatchProgressBottomSheet : BottomSheetDialogFragment() {
    ...
    inner class BatchAppAdapter : RecyclerView.Adapter<BatchAppAdapter.ViewHolder>() {
        ...
        inner class ViewHolder(
            private val binding: ItemBatchAppBinding
